...
%package data
Summary: data components for the jdk-gson package.
Group: Data

%description data
data components for the jdk-gson package.


%prep
%setup -q -n gson-gson-2.3.1
...
%install
xmvn-install  -R .xmvn-reactor -n google-gson -d %{buildroot}
...
/usr/share/maven-metadata/google-gson.xml
/usr/share/maven-poms/google-gson/gson.pom
